    ...
    ep.playlist = [
      {
        ...
        src: 'https://s3.eu-central-1.amazonaws.com/unbeschrieben/zeig_mir_die_welt.mp3',
        type: 'audio/mpeg'
      },
      {
        name: 'Absinth',
        view: 'views/tracks/absinth.html',
        src: 'https://s3.eu-central-1.amazonaws.com/unbeschrieben/absinth.mp3',
        type: 'audio/mpeg'
      },
      {
        name: 'Bruder',
        view: 'views/tracks/bruder.html',
        src: 'https://s3.eu-central-1.amazonaws.com/unbeschrieben/bruder.mp3',
        type: 'audio/mpeg'
      },
      {
        name: 'Alles Brennt',
        view: 'views/tracks/allesbrennt.html',
        src: 'https://s3.eu-central-1.amazonaws.com/unbeschrieben/alles_brennt.mp3',
        type: 'audio/mpeg'
      },
      {
        name: 'Das Versprechen',
        view: 'views/tracks/versprechen.html',
        src: 'https://s3.eu-central-1.amazonaws.com/unbeschrieben/das_versprechen.mp3',
        type: 'audio/mpeg'
      }
    ];
